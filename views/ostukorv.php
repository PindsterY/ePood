...
<div class="cart-view-table-back">
    <form method="post" action="cart_update.php">
        <table width="100%" cellpadding="6" cellspacing="0">
            ...
            ?>
            <tr>
                <td colspan="5"><span style="float:right;text-align: right;"><?php echo $shipping_cost . $list_tax; ?>
                        Hind kokku : <?php echo sprintf("%01.2f", $grand_total); ?></span></td>
            </tr>
            <tr>
